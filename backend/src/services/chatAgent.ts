...
export async function chatWithAgent(
  ...
  const systemPrompt = `You are the DTLIBRARY'S Memory Agent. You have persistent memory of ALL shows stored in a database. You are currently viewing '${packet.show.title}'.
